...
import com.hjy.mtpattern.chap12.ms.*;
 ...
 * 基于Master-Slave模式可复用代码的质数生成器
 */
public class ParallelPrimeGenerator {

    public static void main(String[] args) throws Exception{

        PrimeGeneratorService primeGeneratorService =new  ParallelPrimeGenerator().new PrimeGeneratorService();
    ...
    */
    private static class PrimeGenerator extends WorkerThreadSlave<Range,Set<BigInteger>>{
        ...
        @Override
        protected Set<BigInteger> doProcess(Range rang) throws Exception {
            Set<BigInteger> result = new TreeSet<BigInteger>();
            BigInteger start = BigInteger.valueOf(rang.lowerBound);
            BigInteger end = BigInteger.valueOf(rang.upperBound);
