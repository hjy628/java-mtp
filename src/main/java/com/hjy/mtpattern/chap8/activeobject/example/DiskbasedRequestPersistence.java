    ...
    class SectionBasedDiskStorage{
        ...
        */
        ...
        public String[] apply4Filename(MMSDeliverRequest request){
            ...
            fileName[0] = storageBaseDir + File.separator+sectionName+File.separator+new DecimalFormat("0000").format(iFileCount)
        ...
        private boolean removeSection(String sectionName){
            boolean result = true;
            File dir = new File(storageBaseDir+File.separator+sectionName);
            for (File file :
                    dir.listFiles()) {
